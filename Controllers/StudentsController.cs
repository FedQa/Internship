...
namespace Internship.Controllers
{
    ...
    {
        private readonly hseInternshipContext _context;

        public StudentsController(hseInternshipContext context)
        {
            _context = context;
        }
        ...
        public IActionResult Index(string sortOrder, string currentFilter)
        {
            ...
            ViewData["PatronymicSortParm"] = sortOrder == "patronymic_asc" ? "patronymic_desc" : "patronymic_asc";
            ViewData["GroupIdSortParm"] = sortOrder == "groupId_asc" ? "groupId_desc" : "groupId_asc";
            ViewData["GpaSortParm"] = sortOrder == "gpa_asc" ? "gpa_desc" : "gpa_asc";
        ...
        public async Task<IActionResult> Create([Bind("IdStudent,IdPractice,Name,Surname,Patronymic,GroupId,Gpa,ResumeLink")] Student student)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("IdStudent,IdPractice,Name,Surname,Patronymic,GroupId,Gpa,ResumeLink")] Student student)
        {
        ...
        public async Task<IActionResult> DeleteConfirmed(int id)
        {
            ...
            {
                return Problem("Entity set 'hseInternshipContext.Students'  is null.");
            }
            var student = await _context.Students.FindAsync(id);
            if (student != null)
            {
